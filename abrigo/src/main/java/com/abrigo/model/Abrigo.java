...
public class Abrigo {
    ...
    private String regiao;           // NOVO: bairro ou região
    private int temperatura;         // NOVO: temperatura no local
    private String recursos;         // NOVO: recursos disponíveis (separados por vírgula)
